...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Location = System::Drawing::Point(130, 97);
			this->textBox1->Margin = System::Windows::Forms::Padding(10, 9, 10, 9);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(432, 55);
			...
			this->label1->Location = System::Drawing::Point(122, 40);
			this->label1->Margin = System::Windows::Forms::Padding(10, 0, 10, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(31, 48);
			...
			this->label2->Location = System::Drawing::Point(122, 201);
			this->label2->Margin = System::Windows::Forms::Padding(10, 0, 10, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(242, 48);
			this->label2->TabIndex = 3;
			this->label2->Text = L"Postfix form";
			...
			this->label3->Size = System::Drawing::Size(0, 48);
			this->label3->TabIndex = 4;
			this->label3->Click += gcnew System::EventHandler(this, &Form1::Label3_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(568, 58);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(91, 64);
			...
			this->AllowDrop = true;
			this->AutoScaleDimensions = System::Drawing::SizeF(24, 48);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->BackColor = System::Drawing::SystemColors::ControlLight;
			this->ClientSize = System::Drawing::Size(714, 285);
